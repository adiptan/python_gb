...
if __name__ == '__main__':
    print(f'Rate for USD is {currency_rates("Usd")} local func call')
    print(f'Rate for EUR is {currency_rates("EuR")} local func call')
    print(f'Rate for TUG is {currency_rates("TUG")} local func call')
